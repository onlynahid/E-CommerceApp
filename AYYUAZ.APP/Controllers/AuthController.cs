...
public class AuthController : ControllerBase
{
    ...
    public ActionResult<object> GetCurrentUser()
    {
        ...
        catch (Exception ex)
        {
            ...
            return BadRequest(new { message = "Failed to get user information", error = ex.Message });
        }
    }
    ...
    public async Task<ActionResult> ChangeEmail([FromBody] ChangeEmailDto changeEmailDto)
    {
        ...
        {
            _logger.LogError(ex, "Internal server error during email change");
            return StatusCode(500, new
            {
                success = false,
                message = "Internal server error occurred",
