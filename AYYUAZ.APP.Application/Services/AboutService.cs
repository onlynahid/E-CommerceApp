...
namespace AYYUAZ.APP.Application.Services
{
    public class AboutService : IAboutService
    {
        ...
        {
            var about = await _aboutRepository.GetByTitleAsync(title);
            return about == null ? throw new KeyNotFoundException("Not Found About Title") : MapToDto(about);
        }
        ...
        public async Task<AboutDto> GetLatestAboutAsync()
        {
            ...
            return latestAbout == null ? throw new KeyNotFoundException("Not Found LatestAbout") : MapToDto(latestAbout);
        }
